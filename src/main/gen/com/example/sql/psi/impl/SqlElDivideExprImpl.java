...
public class SqlElDivideExprImpl extends SqlElExprImpl implements SqlElDivideExpr {

  public SqlElDivideExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitElDivideExpr(this);
  }

...
public class SqlElSubtractExprImpl extends SqlElExprImpl implements SqlElSubtractExpr {

  public SqlElSubtractExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitElSubtractExpr(this);
  }

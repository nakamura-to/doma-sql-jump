...
public class SqlElForDirectiveImpl extends ASTWrapperPsiElement implements SqlElForDirective {

  public SqlElForDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitElForDirective(this);
  }

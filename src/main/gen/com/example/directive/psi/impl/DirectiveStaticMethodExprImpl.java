...
public class DirectiveStaticMethodExprImpl extends DirectiveExprImpl implements DirectiveStaticMethodExpr {

  public DirectiveStaticMethodExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitStaticMethodExpr(this);
  }

...
public class DirectiveGeExprImpl extends DirectiveExprImpl implements DirectiveGeExpr {

  public DirectiveGeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitGeExpr(this);
  }

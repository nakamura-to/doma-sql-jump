...
public class DirectiveEmbeddedVariableDirectiveImpl extends ASTWrapperPsiElement implements DirectiveEmbeddedVariableDirective {

  public DirectiveEmbeddedVariableDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitEmbeddedVariableDirective(this);
  }

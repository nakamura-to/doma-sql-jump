...
public class DirectivePopulateDirectiveImpl extends ASTWrapperPsiElement implements DirectivePopulateDirective {

  public DirectivePopulateDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitPopulateDirective(this);
  }

...
public class DirectiveBindVariableDirectiveImpl extends ASTWrapperPsiElement implements DirectiveBindVariableDirective {

  public DirectiveBindVariableDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitBindVariableDirective(this);
  }

...
public class DirectiveLeExprImpl extends DirectiveExprImpl implements DirectiveLeExpr {

  public DirectiveLeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitLeExpr(this);
  }

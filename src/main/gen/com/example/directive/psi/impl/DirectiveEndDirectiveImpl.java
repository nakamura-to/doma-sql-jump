...
public class DirectiveEndDirectiveImpl extends ASTWrapperPsiElement implements DirectiveEndDirective {

  public DirectiveEndDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

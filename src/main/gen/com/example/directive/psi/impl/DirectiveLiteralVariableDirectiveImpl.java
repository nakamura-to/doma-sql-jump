...
public class DirectiveLiteralVariableDirectiveImpl extends ASTWrapperPsiElement implements DirectiveLiteralVariableDirective {

  public DirectiveLiteralVariableDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DirectiveVisitor visitor) {
    visitor.visitLiteralVariableDirective(this);
  }

...
public class DirectiveFunctionExprImpl extends DirectiveExprImpl implements DirectiveFunctionExpr {

  public DirectiveFunctionExprImpl(@NotNull ASTNode node) {
    super(node);
  }
